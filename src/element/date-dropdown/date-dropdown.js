import '../../../node_modules/jquery-ui-1.12.1.custom/jquery-ui.js'
import '../../../node_modules/jquery-ui-1.12.1.custom/jquery-ui.css'
...
//let clearDate = document.querySelector('.clear-date')
...
let dropdownDateList = document.querySelectorAll('.date-dropdown-block')

for (let index = 0; index < dropdownDateList.length; index++) {
  dropdownDateList[index].id = 'date_dropdown_people_' + index
  //alert(dropdownDateList[index].id)
}
...
//
  ...
  $(function() {
    ...
    for(j = 0; j < dropdownDateList.length; j++) {

      let dropdownDateParent = document.querySelector('#' + dropdownDateList[j].id);
      let dropdownDateCalendarId = document.querySelector('#' + dropdownDateList[j].id + ' .date_range');
      let dropdownStartDate = document.querySelector('#' + dropdownDateList[j].id + ' .startDate');
      let dropdownEndDate = document.querySelector('#' + dropdownDateList[j].id + ' .endDate');
      let dropdownRangeDate = document.querySelector('#' + dropdownDateList[j].id + ' .range-date');
      ...
      //let rangeDateIcon = document.querySelector('#' + dropdownDateList[j].id + ' .input-date-block' + ' .end-date-icon')
      ...
      clearDate.onclick = function() {
        ...
        $(dropdownEndDate).val("ДД.ММ.ГГГГ");
        $(dropdownRangeDate).val("ДД.ММ.ГГГГ");
      }

      dropdownDateCalendarOn.onclick = function() {

        if (dropdownDateCalendarId.style.display != 'block') {
          dropdownDateCalendarId.style.display = 'block';
          startDateIcon.textContent = 'expand_less'
          endDateIcon.textContent = 'expand_less'
          // if ( rangeDateIcon != null) {
          //   rangeDateIcon.textContent = 'expand_less'
          // }
        }
        else if (dropdownDateCalendarId.style.display == 'block') {
          dropdownDateCalendarId.style.display = 'none';
          startDateIcon.textContent = 'expand_more'
          endDateIcon.textContent = 'expand_more'
          // rangeDateIcon.textContent
          // if ( rangeDateIcon != null) {
          //   rangeDateIcon.textContent = 'expand_more'
          // }
        }
      }
